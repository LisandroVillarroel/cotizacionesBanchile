...
import { IEstadoIngresoSolicitud, IIngresoSolicitud } from '../modelo/ingresoSolicitud-Interface';
...
ingreso: IIngresoSolicitud =
  ...
  constructor() { }
    ...
    postIngresoSolicitud(ingresoSolicitud: IIngresoSolicitud): Observable<any> {
      ...
      return this.http
        .post<any>(`${environment.apiUrl}/ingreso-solicitud`, ingresoSolicitud,{headers: this.headers})
