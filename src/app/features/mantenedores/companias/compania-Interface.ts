export interface ICompaniaSeguro {
...
export interface DatosCompaniaSeguro {
  codigo: number;
  mensaje: string;
  p_cursor: ICompaniaSeguro[];
  vcEstado: string;
...
export interface IContactoCompaniaCrear {
  p_id_usuario: string;
  p_tipo_usuario: string;
  p_id_compania_seguro: number;
  p_nombre_ejecutivo_cia: string;
...
export interface DatosContactoCompaniaCrear {
  codigo: number;
  mensaje: string;
  vcEstado: string;
  vcEstadoCreacion: string;
...
export interface DatosTipoSeguroCompaniaCrear {
  codigo: number;
  mensaje: string;
  vcEstadoCreacion: string;
}
