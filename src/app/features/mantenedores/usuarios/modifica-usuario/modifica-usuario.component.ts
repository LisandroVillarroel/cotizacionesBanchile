...
export class ModificaUsuarioComponent implements OnInit {
  ...
  grabar() {
    ...
    const rutParaBD = formatRut(
      cleanRut(this.modificaUsuario().get('rutUsuarioNuevo')!.value as string),
      RutFormat.DASH,
    );

    this.usuario = {
      p_id_usuario_nuevo: this.modificaUsuario().get('idUsuarioNuevo')!.value as string,
      p_tipo_usuario_nuevo: this.modificaUsuario().get('tipoUsuarioNuevo')!.value as string,
      p_rut_usuario_nuevo: rutParaBD,
      p_nombre_usuario_nuevo: this.modificaUsuario().get('nombreUsuarioNuevo')!.value as string,
      p_apellido_paterno_usuario_nuevo: this.modificaUsuario().get('apePaternoUsuarioNuevo')!
        .value as string,
      p_apellido_materno_usuario_nuevo: this.modificaUsuario().get('apeMaternoUsuarioNuevo')!
        .value as string,
      p_mail_usuario_nuevo: this.modificaUsuario().get('mailUsuarioNuevo')!.value as string,
      p_telefono_usuario_nuevo: this.modificaUsuario().get('telefonoUsuarioNuevo')!.value as string,
      p_id_dependencia_usuario_nuevo: this.modificaUsuario().get('dependenciaUsuarioNuevo')!
        .value as string,
