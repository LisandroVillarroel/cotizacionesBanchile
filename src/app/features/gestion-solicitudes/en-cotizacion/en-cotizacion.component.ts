...
@Component({
  ...
  imports: [
    ...
    FormsModule,
    CommonModule
  ],  templateUrl: './en-cotizacion.component.html',
  styleUrl: './en-cotizacion.component.css'
})
export class EnCotizacionComponent {
  cotizadas = input.required<ISolicitudG[] | undefined>();
  ...
  datosFiltrados() {
    ...
    return this.cotizadas()!.filter(item => {
